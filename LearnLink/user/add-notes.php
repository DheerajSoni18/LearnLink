...
<html lang="en">
<head>
    <title>LearnLink || Add Notes</title>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Notes Title <span style="color:red";>*</span></label>
                                    <input type="text" class="form-control"  name="notestitle" value="" required='true'>

                                 
                                </div>
                                 <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Subject <span style="color:red";>*</span></label>
                                    <input type="text" class="form-control"  name="subject" value="" required='true'>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Notes Description <span style="color:red";>*</span></label>
                                    <textarea class="form-control"  name="notesdesc" value="" required='true'></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Upload File <span style="color:red";>*</span></label>
