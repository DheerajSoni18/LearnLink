...
<html lang="en">
<head>
    <title>LearnLink || Update Notes</title>
...
<a href="changefile3.php?editid=<?php echo $row->ID;?>" > &nbsp;<strong style="color: red">Edit</strong></a>
...
<a href="changefile4.php?editid=<?php echo $row->ID;?>" > &nbsp;<strong style="color: red">Edit</strong></a>
