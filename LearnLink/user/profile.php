...
if (strlen($_SESSION['ocasuid']==0)) {
  ...
  $sql="update tbluser set FullName=:name, MobileNumber=:mobilenumber, Email=:email, RegDate=:regdate where ID=:uid";
...
{               ?>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="name" value="<?php  echo $row->FullName;?>" required='true' readonly>
                               ...
                               <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Contact Number <span style="color:red";>*</span></label>
                                ...
                                <div class="mb-3">
                                   ...
                                   <input type="text" class="form-control" id="regdate" name="regdate" value="<?php  echo $row->RegDate;?>" readonly>
                                </div>
